...
/**
 * 字段自减更新模版，用于字段根据条件自增的情况，拼写类似FIELD_NAME=FIELD_NAME-1的SQL片段
 * @author LiuHG
 * @see UpdateBuilder UpdateBuilder
 */
public class FieldDecrease implements UpdateFragmentTemplate {

    private final String attrName;
    private final int step;

    public FieldDecrease(String attrName, int step){
        this.attrName = attrName;
        this.step = step;
    }

    public FieldDecrease(String attrName){
        this.attrName = attrName;
        this.step = 1;
    }
